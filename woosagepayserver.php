 ...
 * Version: 1.0.8
 * Author: Aesopagency (forked from PatSaTECH)
 * Author URI: http://aesopagency.com (http://www.patsatech.com)
 * Contributors: aesopagency, patsatech
            ...
            <table class="form-table">
                ...
                if ($this->is_valid_for_use()) :
                    ...
                    <div class="inline error"><p>
                            <strong><?php _e('Gateway Disabled', 'woothemes'); ?></strong>: <?php _e('SagePay Server does not support your store currency.', 'woothemes'); ?>
                        </p></div>
                    <?php
